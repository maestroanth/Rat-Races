...
bool check_collision2( SDL_Rect box, SDL_Rect wall2 )//write in my own collision variables, add a - velocity to box
{
    //The sides of the rectangles
    int leftA, leftB;
    int rightA, rightB;
    ...
    //Calculate the sides of rect B
    leftB = wall2.x;
    rightB = wall2.x + wall2.w;
    topB = wall2.y;
    bottomB = wall2.y + wall2.h;
